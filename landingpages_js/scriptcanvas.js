...
document.addEventListener('DOMContentLoaded', function () {
    document.getElementById('runProject1Btn').addEventListener('click', function () {
        runProject('http://127.0.0.1:5000/run-project1'); // Corrected endpoint
    });
});
// Add event listeners to each button
// document.getElementById('runProject1Btn').addEventListener('click', function () {
//     runProject('http://127.0.0.1:5000//run-project1');
// });

// document.getElementById('runProject2Btn').addEventListener('click', function () {
//     runProject('http://127.0.0.1:5000/run-project2');
// });

// document.getElementById('runProject3Btn').addEventListener('click', function () {
//     runProject('http://127.0.0.1:5000/run-project3');
// });

// document.getElementById('runProject4Btn').addEventListener('click', function () {
//     runProject('http://127.0.0.1:5000/run-project4');
// });